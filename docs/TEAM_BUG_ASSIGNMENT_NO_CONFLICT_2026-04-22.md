...
- Calendar ô ngày tháng quá nhỏ, task bị che khuất.
...
- Board/cycle sửa không lưu (chỉ xử lý phần wrapper, state sync ngoài LOCKED).
...
- Đánh dấu backlog `OWNER-HANDOFF` để Cường xử lý sau khi xong nhóm file hiện tại.
