...
.yellow-bg { background: #FFFAE6; font-size: 16px; }
.light-blue { background: #E6FCFF; color: #00B8D9; }
.green-bg { background: #E3FCEF; color: #36B37E; }
...
.status-badge.completed { background: #DFE1E6; color: #42526E; }
